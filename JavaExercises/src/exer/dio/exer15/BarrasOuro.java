...
public class BarrasOuro {
    ...
    class Vertex {
        ...
        public int calculateTotalDistance(Vertex previousCity) {
            ...
            for (Edge edge : edgesList) {
                ...
                travelsNumber = (int) Math.ceil(edge.destinationVertex.taxQuantity / BarrasOuro.cargoCapacity) * 2;
    ...
    public static void main(String[] args) {
        ...
        BarrasOuro.cargoCapacity = Integer.parseInt(lineArgs[1]);
        ...
        BarrasOuro goldBars = new BarrasOuro();
